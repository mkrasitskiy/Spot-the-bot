...
np.savetxt("data_words_bot2.csv", data_words_bot, delimiter=",",fmt='%s')
np.savetxt("data_words_human2.csv", data_words_human, delimiter=",",fmt='%s')
...
dict_books = np.genfromtxt(fname='/home/rfreyrebonilya/Spotthebot/Resultados/Wikipedia/dalls1000_0/dict.csv', delimiter=',',dtype="|U")
...
np.savetxt("uh2.csv", uh, delimiter=",")
np.savetxt("ub2.csv", ub, delimiter=",")


# In[ ]:


np.savetxt("sh2.csv", sh, delimiter=",")
np.savetxt("sb2.csv", sb, delimiter=",")


# In[ ]:


np.savetxt("vth2.csv", vth, delimiter=",")
np.savetxt("vtb2.csv", vtb, delimiter=",")


# In[ ]:


np.savetxt("dicth2.csv", vectorizer.get_feature_names(), delimiter=",",fmt='%s')
np.savetxt("dictb2.csv", vectorizer1.get_feature_names(), delimiter=",",fmt='%s')


# In[ ]:


np.savetxt("Ah2.csv", Ah, delimiter=",")
np.savetxt("Ab2.csv", Ab, delimiter=",")
