...
len(data_words)
np.savetxt("data_wordsB.csv", data_words, delimiter=",",fmt='%s')
...
np.savetxt("uB.csv", u, delimiter=",")


# In[ ]:


np.savetxt("sB.csv", s, delimiter=",")


# In[ ]:


np.savetxt("vtB.csv", vt, delimiter=",")


# In[ ]:


np.savetxt("dictB.csv", vectorizer.get_feature_names(), delimiter=",",fmt='%s')


# In[ ]:


np.savetxt("A_B.csv", A, delimiter=",")
