...
np.savetxt("data_words_bot.csv", data_words_bot, delimiter=",",fmt='%s')
np.savetxt("data_words_human.csv", data_words_human, delimiter=",",fmt='%s')
...
print(data_lemmatized_bot[0:20])
print(data_lemmatized_human[0:20])
...
dict_books = np.genfromtxt(fname='/home/rfreyrebonilya/Spotthebot/Resultados/Books/balls1000_t/dictB.csv', delimiter=',',dtype="|U")

print('Dict used:',dict_books[:20])

#vectorizer = CountVectorizer(analyzer='word',       
#                             #min_df=3,                        # minimum  occurences of a word 
...
vectorizer.fit_transform(dict_books)
vectorizer1.fit_transform(dict_books)
...
print(vectorizer1.get_feature_names()[0:20])
...
t0 = time()
uh, sh, vth = svds(Ah,k=1000)

t1 = time()
print(t1 - t0)

t0 = time()
ub, sb, vtb = svds(Ab,k=1000)
...
np.savetxt("uh.csv", uh, delimiter=",")
np.savetxt("ub.csv", ub, delimiter=",")


# In[ ]:


np.savetxt("sh.csv", sh, delimiter=",")
...
np.savetxt("vth.csv", vth, delimiter=",")
np.savetxt("vtb.csv", vtb, delimiter=",")


# In[ ]:


np.savetxt("dicth.csv", vectorizer.get_feature_names(), delimiter=",",fmt='%s')
np.savetxt("dictb.csv", vectorizer1.get_feature_names(), delimiter=",",fmt='%s')


# In[ ]:


np.savetxt("Ah.csv", Ah, delimiter=",")
np.savetxt("Ab.csv", Ab, delimiter=",")
