...
#run a little sample
#corpus_final=corpus_final[0:10]
...
#Spanish dictionary
#dic = pd.read_csv('espanol.txt',encoding='utf8').values
...
len(data_words)
np.savetxt("data_wordsB0.csv", data_words, delimiter=",",fmt='%s')
...
np.savetxt("uB0.csv", u, delimiter=",")


# In[ ]:


np.savetxt("sB0.csv", s, delimiter=",")


# In[ ]:


np.savetxt("vtB0.csv", vt, delimiter=",")


# In[ ]:


np.savetxt("dictB0.csv", vectorizer.get_feature_names(), delimiter=",",fmt='%s')


# In[ ]:


np.savetxt("A_B0.csv", A, delimiter=",")
